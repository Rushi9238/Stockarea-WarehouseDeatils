...
const wearhouseData=createSlice({
    name:"wearhouse",
    initialState:{
        wearhouse:[
            {
    ...
    reducers:{
        viewDataAction:(state,action)=>{
            return state.wearhouse
        },
...
export const {viewDataAction,editDataAction}=wearhouseData.actions
export default wearhouseData.reducer